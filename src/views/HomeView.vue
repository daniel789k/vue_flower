<template>
    ...
    <section class="mb-5 container my-5">
    ...
    <section class="pb-5 container">
        <div class="row">
            <div class="col-lg-6 d-flex align-items-center justify-content-end">
                <div class="text-end">
                    <h2>會員計劃</h2>
                    <p class="lh-lg text-secondary">成為我們的會員，享受專屬優惠和生日禮物。</p>
                </div>
            </div>
            <div class="col-lg-6">
